# 1 "/tmp/tmpitqoiw10"
#include <Arduino.h>
# 1 "/home/jetson/linorobot2_hardware/calibration/src/firmware.ino"
# 15 "/home/jetson/linorobot2_hardware/calibration/src/firmware.ino"
#include <Arduino.h>
#include "config.h"
#include "motor.h"
...
void printSummary();
#line 51 "/home/jetson/linorobot2_hardware/calibration/src/firmware.ino"
void setup()
{
    Serial.begin(9600);
    while (!Serial) {
